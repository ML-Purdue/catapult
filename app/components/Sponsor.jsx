          ...
          {sponsors.map((sponsor, i) => (
            <a
              ...
              className="
                ...
                border border-[#151c43]/15
                text-[#151c43]
                font-semibold tracking-wide
                text-xl
                hover:scale-105
                hover:bg-white/20
                hover:shadow-[0_10px_40px_rgba(21,28,67,0.15)]
            ...
            >
              {sponsor.logo
                ? <Image src={sponsor.logo} alt={sponsor.name} width={200} height={75} className="max-h-12 object-contain" />
                : sponsor.name}
            </a>
          ))}
        </div>
